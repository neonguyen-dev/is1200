...
const uint8_t const character[] = {
	0x3f, 0xdf, 0xdf, 0xcf, 0xd7, 0xb7, 0x7b, 0xfb, 0x8b, 0x73, 0xfb, 0xfb, 0x97, 0xef, 0x1f, 0xff, 
	0xfe, 0xfd, 0xf3, 0xeb, 0xeb, 0xdd, 0xde, 0xdf, 0xdb, 0xd5, 0xea, 0xea, 0xea, 0xea, 0xea, 0xf2
};
